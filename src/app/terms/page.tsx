    ...
    return (
        <div className="container mx-auto px-6 py-20 max-w-4xl">
            ...
            <div className="prose prose-slate max-w-none text-foreground/70 font-medium leading-relaxed italic">
                ...
                <h2 className="text-2xl font-bold mt-8 mb-4">Student contributions</h2><p>Reviews describe individual student experiences. They are not school rankings, platform endorsements, or guarantees. Relevant positive and negative experiences follow the same <a href="/guidelines" className="underline">review guidelines</a>.</p><p className="mt-20 text-sm opacity-50 italic">Last updated: February 11, 2026</p>
            </div>
        </div>
    );
}
