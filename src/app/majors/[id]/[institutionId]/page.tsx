    ...
    return (
        <div className="container mx-auto px-6 py-16 max-w-7xl">
            ...
            >
                ...
                Return to National {major.title}
            </a>
            ...
            <div className="mb-20 border-b-2 border-earth-sage/20 pb-16 flex flex-col md:flex-row md:items-end justify-between gap-12">
                <div className="max-w-4xl">
                    ...
                    <h1 className="text-7xl font-funky text-foreground tracking-tight leading-[0.85] mb-6">{institution.name}</h1>
                    <p className="text-2xl font-funky text-earth-terracotta italic tracking-tight">Academic Department Insights</p>
                </div>
                <a href="/write-review" className="coffee-btn px-10 py-5 text-xl w-full md:w-auto text-center shadow-[6px_6px_0px_#433422]">
                    Share Your Truth
                </a>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24">
                ...
                <div className="lg:col-span-5 space-y-12">
                    <div className="coffee-card bg-earth-parchment/30">
                        <h3 className="text-2xl font-funky text-foreground mb-10 italic border-b border-foreground/5 pb-6">Departmental Scorecard</h3>
                        ...
                        {hideStats ? (
                            <div className="text-center py-12 bg-white/50 border-2 border-dashed border-earth-sage/30 rounded-3xl px-8">
                                <p className="text-[10px] font-bold uppercase tracking-widest text-earth-sage/60 mb-8 italic">
                                    Insights hidden until 5+ voices join the gathering
                                </p>
                                ...
                                <p className="text-[10px] text-foreground mt-6 font-bold uppercase tracking-widest italic">{reviewCount} / 5 CONTRIBUTIONS</p>
                            </div>
                        ) : (
                            <>
                                <div className="flex items-center gap-8 mb-12">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-[10px] font-bold text-earth-sage mt-3 uppercase tracking-widest italic">Institutional Wisdom</span>
                                    </div>
                                </div>
                    ...
                    <div className="coffee-card bg-earth-burgundy text-earth-parchment shadow-[6px_6px_0px_#433422]">
                        ...
                        <h4 className="text-2xl font-funky italic mb-4">Academic Guardrails</h4>
                        <p className="text-sm font-medium leading-relaxed italic opacity-70">
                            These reflections focus purely on the departmental curriculum and faculty dynamics. Distractions of campus life are filtered to maintain academic clarity.
                        </p>
                    </div>
                </div>
                ...
                <div className="lg:col-span-7 space-y-12">
                    <div className="flex items-center justify-between border-b border-foreground/10 pb-8 mb-12">
                        <div>
                            <h3 className="text-4xl font-funky text-foreground tracking-tight italic">Gathered Experiences</h3>
                            <p className="text-[10px] font-bold text-earth-sage uppercase tracking-widest mt-2 italic">Reflections from the path</p>
                        </div>
                        <div className="flex gap-2">
                            <span className="bg-earth-mustard text-foreground px-5 py-2 text-[10px] font-bold uppercase tracking-widest rounded-full border border-foreground/10 shadow-sm italic">Newest Wisdoms</span>
                        </div>
                    </div>

                    {reviews.length === 0 ? (
                        <div className="coffee-card bg-earth-parchment/30 border-dashed py-32 text-center">
                            <h4 className="text-3xl font-funky text-foreground mb-6 italic opacity-40">The silence is profound</h4>
                            <p className="text-foreground font-medium mb-12 max-w-sm mx-auto leading-relaxed italic opacity-70 text-lg">
                                Be the first to enlighten others about the journey of {major.title} at {institution.name}.
                            </p>
