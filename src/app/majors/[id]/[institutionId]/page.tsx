            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24">
                ...
                <div className="lg:col-span-7 space-y-12">
                    <div className="flex items-center justify-between border-b border-foreground/10 pb-8 mb-12">
                        <div>
                            <h3 className="text-4xl font-funky text-foreground tracking-tight italic">Recent Reviews</h3>
                            <p className="text-[10px] font-bold text-earth-sage uppercase tracking-widest mt-2 italic">Student experiences</p>
                        </div>
